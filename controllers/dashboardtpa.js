...
module.exports = {
    ...
    usertpa:function*(next){
        
        var id;
        console.log("hello");
        try{ id=this.currentUser.useid;}
catch(e){id=0;}
       var queryString='select * from tb_user where role=1 and useid=%s';
       var query=util.format(queryString,id);
       var res=yield databaseUtils.executeQuery(query);
       console.log(res);
       yield this.render('usertpa',{
           res:res
       });
